...
data_fname <- "~/data/growth_curves/CTD_IF2_Growth_curves_37.csv"
...
data <- as.data.frame(read.csv("~/data/growth_curves/CTD_IF2_Growth_curves_37_summary.csv", header=T, sep=","))
