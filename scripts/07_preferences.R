...
# temperature
bd_psychrophile=read.csv("~/traits/BacDive_psychrophile.csv")
bd_mesophile=read.csv("~/traits/BacDive_mesophile.csv")
bd_thermophile=read.csv("~/traits/BacDive_thermophile.csv")

# oxygen tolerance
bd_aerobe=read.csv("~/traits/BacDive_aerobe.csv")
bd_aerotolerant=read.csv("~/traits/BacDive_aerotolerant.csv")
bd_anaerobe=read.csv("~/traits/BacDive_anaerobe.csv")
bd_facultative_aerobe=read.csv("~/traits/BacDive_facultative_aerobe.csv")
bd_facultative_anaerobe=read.csv("~/traits/BacDive_facultative_anaerobe.csv")
bd_microaerophile=read.csv("~/traits/BacDive_microaerophile.csv")
bd_microaerotolerant=read.csv("~/traits/BacDive_microaerotolerant.csv")
bd_obligate_aerobe=read.csv("~/traits/BacDive_obligate_aerobe.csv")
bd_obligate_anaerobe=read.csv("~/traits/BacDive_obligate_anaerobe.csv")
