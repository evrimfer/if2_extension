...
data_fname <- "~/data/growth_curves/dN-IF2-Growth-Curves-pH.csv"
...
sample_group_names <- c("WT-pH5","dN-pH5","dG1-pH5",
                        "WT-pH7","dN-pH7","dG1-pH7",
                        "WT-pH8","dN-pH8","dG1-pH8")
...
data <- as.data.frame(read.csv("~/data/growth_curves/dN-IF2-Growth-Curves-pH_summary.csv", header=T, sep=","))

#####  Data Frame #####
data$group=factor(data$group, levels=c("WT-pH5","dN-pH5","dG1-pH5",
                                       "WT-pH7","dN-pH7","dG1-pH7",
                                       "WT-pH8","dN-pH8","dG1-pH8"))


type=rep(c("WT-pH5","dN-pH5","dG1-pH5",
           "WT-pH7","dN-pH7","dG1-pH7",
           "WT-pH8","dN-pH8","dG1-pH8"), each=5)

data$note=type
data$note=factor(data$note, levels=c("WT-pH5","dN-pH5","dG1-pH5",
                                     "WT-pH7","dN-pH7","dG1-pH7",
                                     "WT-pH8","dN-pH8","dG1-pH8"))
...
df_mean_dt=rbind(df_mean_dt, c("WT-pH5", mean(data$Fold.doubling[1:5]), sd(data$Fold.doubling[1:5])))
df_mean_dt=rbind(df_mean_dt, c("dN-pH5", mean(data$Fold.doubling[6:10]), sd(data$Fold.doubling[6:10])))
df_mean_dt=rbind(df_mean_dt, c("dG1-pH5", mean(data$Fold.doubling[11:15]), sd(data$Fold.doubling[11:15])))
df_mean_dt=rbind(df_mean_dt, c("WT-pH7", mean(data$Fold.doubling[16:20]), sd(data$Fold.doubling[16:20])))
df_mean_dt=rbind(df_mean_dt, c("dN-pH7", mean(data$Fold.doubling[21:25]), sd(data$Fold.doubling[21:25])))
df_mean_dt=rbind(df_mean_dt, c("dG1-pH7", mean(data$Fold.doubling[26:30]), sd(data$Fold.doubling[26:30])))
df_mean_dt=rbind(df_mean_dt, c("WT-pH8", mean(data$Fold.doubling[32:35]), sd(data$Fold.doubling[32:35])))
df_mean_dt=rbind(df_mean_dt, c("dN-pH8", mean(data$Fold.doubling[36:40]), sd(data$Fold.doubling[36:40])))
df_mean_dt=rbind(df_mean_dt, c("dG1-pH8", mean(data$Fold.doubling[41:45]), sd(data$Fold.doubling[41:45])))

df_mean_dt=as.data.frame(df_mean_dt[-1,])
colnames(df_mean_dt)=c("sample","mean_dt","sd_dt")
df_mean_dt$sample=factor(df_mean_dt$sample, levels=c("WT-pH5","dN-pH5","dG1-pH5",
                                                     "WT-pH7","dN-pH7","dG1-pH7",
                                                     "WT-pH8","dN-pH8","dG1-pH8"))
...
df_mean_rate=rbind(df_mean_rate, c("WT-pH5", mean(data$Fold.doubling[1:5]), sd(data$Fold.doubling[1:5])))
df_mean_rate=rbind(df_mean_rate, c("dN-pH5", mean(data$Fold.doubling[6:10]), sd(data$Fold.doubling[6:10])))
df_mean_rate=rbind(df_mean_rate, c("dG1-pH5", mean(data$Fold.doubling[11:15]), sd(data$Fold.doubling[11:15])))
df_mean_rate=rbind(df_mean_rate, c("WT-pH7", mean(data$Fold.doubling[16:20]), sd(data$Fold.doubling[16:20])))
df_mean_rate=rbind(df_mean_rate, c("dN-pH7", mean(data$Fold.doubling[21:25]), sd(data$Fold.doubling[21:25])))
df_mean_rate=rbind(df_mean_rate, c("dG1-pH7", mean(data$Fold.doubling[26:30]), sd(data$Fold.doubling[26:30])))
df_mean_rate=rbind(df_mean_rate, c("WT-pH8", mean(data$Fold.doubling[32:35]), sd(data$Fold.doubling[32:35])))
df_mean_rate=rbind(df_mean_rate, c("dN-pH8", mean(data$Fold.doubling[36:40]), sd(data$Fold.doubling[36:40])))
df_mean_rate=rbind(df_mean_rate, c("dG1-pH8", mean(data$Fold.doubling[41:45]), sd(data$Fold.doubling[41:45])))

df_mean_rate=as.data.frame(df_mean_rate[-1,])
colnames(df_mean_rate)=c("sample","mean_r","sd_r")
df_mean_rate$sample=factor(df_mean_rate$sample, levels=c("WT-pH5","dN-pH5","dG1-pH5",
                                                         "WT-pH7","dN-pH7","dG1-pH7",
                                                         "WT-pH8","dN-pH8","dG1-pH8"))
...
ggplot(df_mean_dt, aes(y=as.numeric(mean_dt), x=sample, shape=sample, fill=sample, color=sample)) + 
  ...
  scale_fill_manual(values=c("red","black","gray","red","black","gray","red","black","gray"))+
