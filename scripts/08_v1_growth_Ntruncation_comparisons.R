...
data_fname <- "~/growth_curves/dN-IF2-Growth-Curves-Temperatures.csv"
...
data <- as.data.frame(read.csv("~/growth_curves/dN-IF2-Growth-Curves-Temperatures_summary.csv", header=T, sep=","))
